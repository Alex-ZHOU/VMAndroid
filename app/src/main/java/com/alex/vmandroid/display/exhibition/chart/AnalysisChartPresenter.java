...
public class AnalysisChartPresenter implements AnalysisChartContract.Presenter {
    ...
    public AnalysisChartPresenter(AnalysisChartContract.View view, Context context, AnalysisChart analysisChart){
        this.setView(view);
        this.setContext(context);
        mAnalysisChart = analysisChart;
    }
    ...
    private void showAnalysis() {
        ...
        AppLog.debug("axisNum" + axisNum);
        switch (axisNum) {
            case 1:
                timesList.add(0f);
                formatter.addXAxisText(AnalysisXAxisValueFormatter._NULL_AXIS);
                timesList.add(0f);
                formatter.addXAxisText(AnalysisXAxisValueFormatter._NULL_AXIS);
                break;
            case 2:
    ...
    public class AnalysisChart {
        ...
        //        private int get_20Times() {
//            return _20Times;
//        }
//
//        private void set_20Times(int _20Times) {
//            this._20Times = _20Times;
//        }
//
//        private int get_120UpTimes() {
//            return _120UpTimes;
//        }
//
//        private void set_120UpTimes(int _120UpTimes) {
//            this._120UpTimes = _120UpTimes;
//        }
//
//        private int get_120Times() {
//            return _120Times;
//        }
//
//        private void set_120Times(int _120Times) {
//            this._120Times = _120Times;
//        }
//
//        private int get_100Times() {
//            return _100Times;
//        }
//
//        private void set_100Times(int _100Times) {
//            this._100Times = _100Times;
//        }
//
//        private int get_90Times() {
//            return _90Times;
//        }
//
//        private void set_90Times(int _90Times) {
//            this._90Times = _90Times;
//        }
//
//        private int get_70Times() {
//            return _70Times;
//        }
//
//        private void set_70Times(int _70Times) {
//            this._70Times = _70Times;
//        }
//
//        private int get_60Times() {
//            return _60Times;
//        }
//
//        private void set_60Times(int _60Times) {
//            this._60Times = _60Times;
//        }
//
//        private int get_40Times() {
//            return _40Times;
//        }
//
//        private void set_40Times(int _40Times) {
//            this._40Times = _40Times;
//        }
    }
}
